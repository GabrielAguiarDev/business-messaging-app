...
const MOCK_DIRECTORY: UserAPI[] = [
  {id: 'u2', full_name: 'Bruno Aguiar', role: 'Governança', department: 'Governança', email: 'bruno.aguiar@yago.com', avatar_color: '#3f9d8f', avatar_url: 'https://picsum.photos/seed/bruno-aguiar/900', is_admin: false, is_online: true},
